...
public class ColoredSculkSpreader {
    ...
    public int getNoGrowthRadius() {
        return this.noGrowthRadius;
    }

    public int getChargeDecayRate() {
        return this.chargeDecayRate;
    }

    public int getAdditionalDecayRate() {
    ...
    public static class ChargeCursor{
        ...
        public void update(LevelAccessor p_222312_, BlockPos p_222313_, RandomSource p_222314_, ColoredSculkSpreader p_222315_, boolean p_222316_) {
                ...
                if (this.updateDelay > 0) {
                    ...
                    if (this.charge <= 0) {
                        ...
                        if (blockpos != null) {
                            ...
                            if (p_222315_.isWorldGen() && !this.pos.closerThan(new Vec3i(p_222313_.getX(), this.pos.getY(), p_222313_.getZ()), 15.0D)) {
                                this.charge = 0;
                                return;
                            }
                        ...
                        if (blockstate.getBlock() instanceof ColoredSculkBehaviour) {
        ...
        private static ColoredSculkBehaviour getBlockBehaviour(BlockState p_222334_, DyeColor color) {
            Block block = p_222334_.getBlock();
            if (block instanceof ColoredSculkBehaviour sculkbehaviour) {
                return sculkbehaviour;
            } else {
                return ColoredSculkBehaviour.getDefaultForColor(color);
            }
        }
        ...
        private static BlockPos getValidMovementPos(LevelAccessor p_222308_, BlockPos p_222309_, RandomSource p_222310_) {
            ...
            for (Vec3i vec3i : getRandomizedNonCornerNeighbourOffsets(p_222310_)) {
                ...
                if (blockstate.getBlock() instanceof ColoredSculkBehaviour && isMovementUnobstructed(p_222308_, p_222309_, blockpos$mutableblockpos1)) {
                    blockpos$mutableblockpos.set(blockpos$mutableblockpos1);
                    if (ColoredSculkVein.hasSubstrateAccess(p_222308_, blockstate, blockpos$mutableblockpos1)) {
                        break;
                    }
                }
            }
